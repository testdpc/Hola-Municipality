...
// This script will create tables according to the schema definitions by
// generating equivalent CREATE TABLE statements. It's a pragmatic approach
// to ensure local DB contains required tables for the app to run.
...
async function run() {
  ...
  try {
    for (const s of statements) {
      console.log('Executing statement: ', s.split('\n')[0]);
