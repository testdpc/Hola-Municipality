...
import { useGetInventoryItem, useCreateInventoryItem, useUpdateInventoryItem, useListCategories, useListSuppliers } from "@workspace/api-client-react";
...
export default function InventoryForm() {
  ...
  const form = useForm<z.infer<typeof itemSchema>>({
    ...
    defaultValues: {
      itemCode: "", itemName: "", categoryId: 0, description: "", unitOfMeasure: "pcs",
      currentQuantity: 0, minimumStock: 0, maximumStock: 0, reorderLevel: 0,
      shelfBinLocation: "", purchasePrice: 0, supplierId: undefined
    },
  });
          ...
          <Card className="shadow-sm border-border/50">
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FormField control={form.control} name="minimumStock" render={({ field }) => (
                <FormItem><FormLabel>Min Stock</FormLabel><FormControl><Input type="number" {...field} /></FormControl><FormMessage /></FormItem>
              )} />
              <FormField control={form.control} name="maximumStock" render={({ field }) => (
                <FormItem><FormLabel>Max Stock</FormLabel><FormControl><Input type="number" {...field} /></FormControl><FormMessage /></FormItem>
              )} />
              ...
              <FormField control={form.control} name="shelfBinLocation" render={({ field }) => (
                <FormItem><FormLabel>Shelf/Bin Location</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>
              )} />
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm border-border/50">
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField control={form.control} name="purchasePrice" render={({ field }) => (
                <FormItem><FormLabel>Purchase Price (KES)</FormLabel><FormControl><Input type="number" step="0.01" {...field} /></FormControl><FormMessage /></FormItem>
              )} />
