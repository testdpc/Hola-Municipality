...
export const ListInventoryItemsResponseItem = zod.object({
  ...
  "procurementOfficerId": zod.number().nullish(),
  "procurementOfficerName": zod.string().nullish(),
  "custodianName": zod.string().nullish(),
...
export const CreateInventoryItemBody = zod.object({
  ...
  "procurementOfficerId": zod.number().optional(),
  "custodianName": zod.string().optional(),
